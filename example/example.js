...
// List styles testing function
async function testListStyles() {
    const listStylesHtml = `
        <!-- List Style Inheritance Edge Cases -->
    ...
    const fileBuffer = await HTMLtoDOCX(listStylesHtml, null, {
        orientation: 'portrait',
        margins: { top: 720, right: 720, bottom: 720, left: 720 },
        title: 'List Edge Cases Test',
    });

    fs.writeFileSync('./example-list-edge-cases-test.docx', fileBuffer);
    console.log('✅ List styles test completed: example-list-edge-cases-test.docx');
}

// Export for testing
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { testListStyles };
}